...
public static class HarmonyAccessToolsExtensionBackports {
    // ======================================================================
    // following is all of AccessToolExtensions from upstream.
    ...
    ///
    public static IEnumerable<Type> InnerTypes(this Type type) => HarmonyBackports.AccessTools.InnerTypes(type);
